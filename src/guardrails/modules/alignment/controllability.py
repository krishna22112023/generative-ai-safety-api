"""
RICE : Robustness, Interpretability, Controllability, Ethics
Controllability : LLM's ability to call tools correctly in an agentic setting
Interpretability : LLM's ability to explain its reasoning
Ethics : LLM's ability to reason about ethical implications of its actions
Robustness : LLM's ability to handle adversarial inputs (this should be handled before deployment, hence a separate module in robustness.py)
"""
...
def run_check(trace: Trace) -> Optional[ScanResult]:
    """
